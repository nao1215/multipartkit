...
```console
git clone https://github.com/nao1215/multipartkit.git
cd multipartkit
...
- `src/` contains public and internal library modules
...
- If a module is intentionally target-specific, document that
  constraint in code comments and in the README or doc comments.
